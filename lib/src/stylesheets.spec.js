...
const { getColorTable, colorTableToRTF, matchDeclarations } = require('./stylesheets')
...
describe('getColorTable', () => {
  it('should return an object of all used colors', () => {
    const sheet = csstree.parse(styles)
...
describe('colorTableToRTF', () => {
  it('should return a string', () => {
    const res = colorTableToRTF(getColorTable(csstree.parse(styles)))
    expect(res).toMatchSnapshot()
  })
})
