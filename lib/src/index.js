...
function highlight(language, value, theme) {
  ...
  result.value = renderRTF(result.value, theme)
  return result
}

/* Highlight `value` with auto language detection. */
function highlightAuto(value, theme) {
  const result = lowlight.highlightAuto.call(this, value)
  result.value = renderRTF(result.value, theme)
  if (result.secondBest) {
    result.secondBest.value = renderRTF(result.secondBest.value, theme)
  }
  return result
}
